# Sukurkite Flask aplikaciją, kuri valdys restoranų užsakymų sistemą.
# Reikalavimai:
# 1. Sukurti dvi lenteles:
#   a. Staliukas (Staliukas): id, numeris, vietų_skaičius
#   b. Užsakymas (Užsakymas): id, užsakymo_aprašymas, kaina,
#      staliukas_id (ForeignKey)
# 2. CRUD operacijos:
#   a. Pridėti naują staliuką.
#   b. Pridėti naują užsakymą ir priskirti jį staliukui.
#   c. Peržiūrėti visus staliukus su jų užsakymais.
#   d. Ištrinti staliuką (galima tik tada, jei jis neturi užsakymų).
# 3. Atvaizduoti duomenis HTML šablonuose:
#   a. Lentelė su visais staliukais ir jų užsakymų skaičiumi.
#   b. Kiekvieno staliuko puslapis su jo užsakymais.
#   c. Forma naujam užsakymui pridėti.
